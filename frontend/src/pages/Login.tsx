      ...
      <main className="login-page-container">
          <form onSubmit={handleSubmit} className="login-form">
            ...
            <p className="mt-2 text-sm text-gray-500/90 dark:text-gray-400 ">
              {state=== 'login' ? 'Please enter email and password to access.' : 'Please enter your details to create an acount.'}
            </p>
            {state!== 'login' && (
              <div className="mt-4">
                ...
                <div className="relative mt-2">
                  ...
                  <input onChange={(e)=>setUserName(e.target.value)} value={username} className="login-input" required type="text" placeholder="enter a username" />
                </div>
              </div>
            )}
           ...
           {/* Email */}
            ...
            <div className="mt-4">
                ...
                <div className="relative mt-2">
                  ...
                  <input onChange={(e)=>setEmail(e.target.value)} value={email} className="login-input" required type="email" placeholder="Please enter your email" />
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="relative mt-2">
                  ...
                  <input onChange={(e)=>setPassword(e.target.value)} value={password} className="login-input pr-10" required  placeholder="Please enter your password" type={showPassword? 'text' : 'password'} />
