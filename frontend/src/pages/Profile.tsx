    ...
    <div className="page-container">
      {/* Header  */}
       ...
       <div className="profile-content">
            ...
            <Card>
              {/* card title  */}
              <div className="flex in-checked: gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Member since {new Date(user?.createdAt || '' ).toLocaleDateString()}</p>
                </div>
              </div>
              ...
              <Card>
                ...
                <div className="grid grid-cols-2 gap-4 ">
                  <div className="text-center p-4 bg-emerald-50 dark:bg-emerald-900/10 rounded-xl">
                    ...
                    <p className="text-slate-400 text-sm dark:text-slate-400 ">Food entries</p>
                  </div>
                <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/10 rounded-xl ">
                  ...
                  <p className="text-slate-400 text-sm dark:text-slate-400 ">Activities</p>
                </div>
                </div>
              </Card>
